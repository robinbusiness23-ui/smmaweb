...
function Home({ editorMode, setEditorMode }: { editorMode: boolean; setEditorMode: (v: boolean) => void }) {
  ...
  return (
    <main className="min-h-screen overflow-x-hidden">
      ...
      <a
        href="https://wa.me/4915XXXXXXXXX?text=Hallo%2C%20ich%20interessiere%20mich%20f%C3%BCr%20euren%20Social-Media-Service."
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-5 right-5 z-50 flex items-center gap-3 rounded-2xl px-4 py-3 md:px-5 md:py-3.5 font-bold text-white text-sm shadow-2xl group transition-all duration-300 hover:scale-105"
        ...
        <span className="hidden sm:block">WhatsApp schreiben</span>
        {/* Pulse ring */}
